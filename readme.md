[![Tests](https://github.com/genuine-developer/laravel-messenger/actions/workflows/run-tests.yml/badge.svg)](https://github.com/genuine-developer/laravel-messenger/actions/workflows/run-tests.yml)
